...
// $pendapatan_hari_ini = $db->query("SELECT SUM(total_transaksi) AS jml FROM photobooth_transaksi WHERE status_transaksi='1' AND DATE(tanggal_photobooth_transaksi)='$tgl_hari_ini'")->fetch_assoc()['jml'];
  ...
  <div class="wrapper">
    ...
    <aside class="main-sidebar elevation-4 sidebar-light-lightblue">
      <a href="#" class="brand-link navbar-lightblue" style="color: white !important">
        ...
        <span class="brand-text" style="font-size: 100%"><b>TIKET SPOT FOTO</b></span>
      </a>
      <div class="sidebar">
        <nav class="mt-4">
    ...
    <div class="content-wrapper">
      ...
      if ($page == "dashboard") {
        if ($action == "") {
          include "view/dashboard/dashboard_photobooth.php";
        }
      } elseif ($page == "transaksi_photobooth") {
        if ($action == "kelola") {
          include "view/transaksi_photobooth/transaksi_photobooth_kelola.php";
        } elseif ($action == "tambah") {
          include "view/transaksi_photobooth/transaksi_photobooth_tambah.php";
        } elseif ($action == "detail") {
          include "view/transaksi_photobooth/transaksi_photobooth_detail.php";
        }
        ...
        if ($action == "kelola") {
          include "view/laporan/lap_closing_kasir_photobooth.php";
        }
      } else {
