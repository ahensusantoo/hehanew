    ...
    <div class="row">
      <div class="col-md-12">
        <div class="card card-primary">
          ...
          <form role="form" method="post" action="view/akun/proses_data.php" enctype="multipart/form-data">
            <div class="card-body">    
              ...
              <div class="form-group">
                <label for="stts_login_adm_ns">Hak Akses Login NS</label>
                <select name="stts_login_adm_ns" class="form-control" id="stts_login_adm_ns" required>
                  <option value="0" <?php if($data_admin['stts_login_adm_ns'] == "0"){ echo "checked"; }?> >Tidak Ada Akses</option>
                  <option value="1" <?php if($data_admin['stts_login_adm_ns'] == "1"){ echo "selected"; }?>>Memiliki Akses</option>
                </select>
              </div>
            </div>
