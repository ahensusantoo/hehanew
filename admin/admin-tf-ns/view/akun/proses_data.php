...
if (isset($_POST['tambah_admin'])){
    ...
    $stts_login_adm_ns = antiSQLi($_POST['stts_login_adm_ns']);
    ...
    $query = "INSERT INTO admin (id_admin, nama_admin, username_admin, password_admin, jabatan_admin, stts_login_adm_ns) VALUES ('$id_admin', '$nama_admin', '$username_admin', '$password_enkripsi', '$jabatan_admin', '$stts_login_adm_ns') ";
    $sql = $db->query($query);
    ...
    gagal_tambah_admin:
    header('Location: '.base_url().$_SESSION['base_php'].'?page=akun&action=kelola');
...
if(isset($_POST['edit_admin'])){
    ...
    $query = "UPDATE admin SET nama_admin='$nama_admin', username_admin='$username_admin', jabatan_admin='$jabatan_admin', stts_login_adm_ns = '$stts_login_adm_ns' $query_ubah_password WHERE id_admin='$id_admin'";
    $sql = $db->query($query);
...
if(isset($_GET['hapus_admin'])){
    ...
    $query = "UPDATE admin SET status_rmv_admin='Y', stts_login_adm_ns = '0' WHERE id_admin='$id_admin'";
    $sql = $db->query($query);
