  ...
  <div class="wrapper">
    <nav class="main-header navbar navbar-expand navbar-white navbar-light">
      ...
      <ul class="navbar-nav ml-auto">
        ...
        <!-- <li class="nav-item mr-2">
            <button class="btn btn-sm btn-success">Penjualan Hari Ini : <?= number_format($tiket_terjual) ?> Tiket / Rp <?= number_format($pendapatan_hari_ini) ?>,-</button>
        </li> -->
        <li class="nav-item mr-2">
            <button class="btn btn-sm btn-info">Printer : <?= @$_SESSION['printer'] ?></button>
        </li>
        <li class="nav-item">
            <button class="btn btn-sm btn-info"><?= @$_SESSION['shift_nama'] ?></button>
        </li>
    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-4">
      <a href="#" class="brand-link">
        <i class="fa-2x fas fa-ticket-alt brand-image img-circle elevation-3 mt-0"></i>
        <span class="brand-text" style="font-size: 100%"><b>TICKETING</b></span>
      </a>
      <div class="sidebar">
        <nav class="mt-2">
          <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            ...
            <li class="nav-item">
              <a href="?page=transaksi_tambah&action=" class="nav-link" id="transaksi_tambah">
            ...
            <li class="nav-item">
              <a href="?page=laporan_transaksi&action=kelola" class="nav-link" id="laporan_transaksi">
                <i class="nav-icon fas fa-scroll"></i>
                <p>
                  Laporan transaksi
                </p>
            ...
            <li class="nav-item">
              <a href="?page=lap_tour_guide&action=kelola" class="nav-link" id="lap_tour_guide">
                <i class="nav-icon fas fa-scroll"></i>
                <p>
                  Laporan Tour Guide
                </p>
    ...
    <div class="content-wrapper">
      ...
      if ($page == "dashboard") {
        if ($action == "") {
          ...
          include "view/dashboard/dashboard_ticketing.php";
        }
      } elseif ($page == "transaksi") {
        if ($action == "kelola") {
          include "view/transaksi/transaksi_kelola.php";
        } elseif ($action == "tambah") {
          include "view/transaksi/transaksi_tambah.php";
        } elseif ($action == "detail") {
          include "view/transaksi/transaksi_detail.php";
        } elseif ($action == "hapus") {
        ...
        if ($action == "kelola") {
          include "view/laporan/lap_closing_kasir.php";
        }
      }elseif ($page == "lap_tour_guide") {
        if ($action == "kelola") {
          include "view/laporan/tiket_masuk/kasir_tour_guide.php";
        }
      }elseif ($page == "laporan_transaksi") {
        if ($action == "kelola") {
          include "view/laporan/tiket_masuk/lap_penjualan.php";
        }
      } else {
