	...
	$harga_diskon           = $_POST['harga_diskon'];
	    ...
	    if(empty($id_merchant_transaksi)){
        	...
        	if(empty($result[0])) {
                ...
                $query = mysqli_query($db, "CALL tambah_keranjang('$idmerchant', '$kd_merchant_employee', '$kd_merchant_produk', '$id_merchant_transaksi', '$catatan_pesanan', '$jumlah_beli', '$diskon', '$harga_diskon')");
