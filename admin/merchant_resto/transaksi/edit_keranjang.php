...
require_once('../../templates/koneksi.php');
    ...
    $stok_setelah          = $_POST['jumlah_data'];
            ...
            $query = mysqli_query($db, "CALL edit_keranjang('$idmerchant', '$kd_merchant_employee', '$id_merchant_produk', '$catatan_pesanan', '$stok_setelah', '$id_merchant_transaksi_detail')");
