...
require_once('../../templates/koneksi.php');
    ...
    $nomeja                = $_POST['nomeja'];
    $servis                = round(@$_POST['servis']);
    $pajak                 = round(@$_POST['pajak']);
	...
	if(isset($result[0])) {
        ...
        '$id_jenis_pembayaran', '$catatan_pesanan', '$idmerchant', '$status_pembayaran', '$idku', '$kd_shift', '$tagihan_nota_sebelum', '$diskon', '$id_referensi', '$nomeja', '$servis', '$pajak')");
