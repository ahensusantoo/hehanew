...
<body class="hold-transition sidebar-mini layout-fixed">
  <div class="wrapper">
      ...
      <div class="sidebar">
        <nav class="mt-2 pb-5">
          <ul class="nav nav-pills nav-sidebar flex-column text-sm" data-widget="treeview" role="menu" data-accordion="false">
            ...
            <li class="nav-item has-treeview" id="pembayaranH">
              ...
              <ul class="nav nav-treeview">
                <li class="nav-item">
                  <a href="?page=pembayaran&action=tambah" class="nav-link" id="pembayarantambah">
                    <i class="far fa-circle nav-icon"></i>
                    <p>Tambah</p>
                  </a>
                </li>
                <li class="nav-item">
                  <a href="?page=pembayaran&action=kelola" class="nav-link" id="pembayarankelola">
                    <i class="far fa-circle nav-icon"></i>
                    <p>Kelola</p>
                  </a>
                </li>
            ...
            <li class="nav-item has-treeview" id="shiftH">
              <a href="#" class="nav-link" id="shift">
              ...
              <ul class="nav nav-treeview">
                <li class="nav-item">
                  <a href="?page=shift&action=tambah" class="nav-link" id="shifttambah">
                    <i class="far fa-circle nav-icon"></i>
                    <p>Tambah</p>
                  </a>
                </li>
                <li class="nav-item">
                  <a href="?page=shift&action=kelola" class="nav-link" id="shiftkelola">
                    <i class="far fa-circle nav-icon"></i>
                    <p>Kelola</p>
                  </a>
                </li>
            ...
            <li class="nav-item has-treeview" id="vouchermerchantH">
              <a href="#" class="nav-link" id="vouchermerchant">
                <i class="nav-icon fas fa-tags"></i>
                <p>
                  Voucher Merchant
                  <i class="right fas fa-angle-left"></i>
              ...
              <ul class="nav nav-treeview">
                <li class="nav-item">
                  <a href="?page=vouchermerchant&action=tambah" class="nav-link" id="vouchermerchanttambah">
                    <i class="far fa-circle nav-icon"></i>
                    <p>Tambah</p>
                  </a>
                </li>
                <li class="nav-item">
                  <a href="?page=vouchermerchant&action=kelola" class="nav-link" id="vouchermerchantkelola">
                    <i class="far fa-circle nav-icon"></i>
                    <p>Kelola</p>
                  </a>
                </li>
            ...
            <li class="nav-item">
              <a href="?page=generalcashier_stall&action=kelola" class="nav-link" id="generalcashier_stall">
                <i class="nav-icon fas fa-users"></i>
                <p>
                  General Cashier Merchant
                </p>
              </a>
            </li>
            <!-- <li class="nav-item has-treeview" id="merchantadminH">
             ...
             <li class="nav-item">
              <a href="?page=supplier&action=kelola" class="nav-link" id="supplier">
                <i class="nav-icon fas fa-users"></i>
                <p>
                  Supplier
                </p>
            ...
            <li class="nav-item">
              <a href="?page=lap_tiket_tour_guide" class="nav-link" id="lap_tiket_tour_guidetiket">
                <i class="nav-icon fas fa-file-invoice"></i>
                <p>
                  Laporan Tour Guide
                </p>
            ...
            <li class="nav-item has-treeview" id="penjualanH">
              ...
              <ul class="nav nav-treeview">
                ...
                <li class="nav-item">
                  <a href="?page=penjualan&action=closingstall" class="nav-link" id="penjualanclosingstall">
                    <i class="far fa-circle nav-icon"></i>
                    <p>Closing Stall</p>
                  </a>
                </li>
                ...
                <li class="nav-item">
                  <a href="?page=penjualan&action=laporanharian" class="nav-link" id="penjualanlaporanharian">
                    <i class="far fa-circle nav-icon"></i>
                    <p>Laporan Harian</p>
                  </a>
                </li>
                <li class="nav-item">
                  <a href="?page=penjualan&action=laporanbulanan" class="nav-link" id="penjualanlaporanbulanan">
                    <i class="far fa-circle nav-icon"></i>
                    <p>Laporan Bulanan</p>
                  </a>
                </li>
                ...
                <li class="nav-item">
                  <a href="?page=penjualan&action=supplier" class="nav-link" id="penjualansupplier">
                    <i class="far fa-circle nav-icon"></i>
                    <p>Laporan Penjualan Supplier</p>
                  </a>
                </li>
              </ul>
            </li>
    ...
    <div class="content-wrapper">
      ...
      if ($page == "dashboard") {
      ...
      } elseif ($page == "generalcashier_stall") {
        if ($action == "kelola") {
          include "view/admin/generalcashier_stall_kelola.php";
        } elseif ($action == "tambah") {
          include "view/admin/generalcashier_stall_tambah.php";
        } elseif ($action == "edit") {
          include "view/admin/generalcashier_stall_edit.php";
        } elseif ($action == "hapus") {
          include "view/admin/admin_hapus.php";
        } 
      }elseif ($page == "supplier") {
        if ($action == "kelola") {
          include "view/admin/supplier/supplier_kelola.php";
        } elseif ($action == "tambah") {
          include "view/admin/supplier/supplier_tambah.php";
        } elseif ($action == "edit") {
          include "view/admin/supplier/supplier_edit.php";
        } elseif ($action == "hapus") {
          include "view/admin/supplier/supplier_hapus.php";
        } 
      ...
      }elseif ($page == "lap_tiket_tour_guide") {
        include "view/laporan/tiket_masuk/kasir_tour_guide.php";
        ...
        if ($action == "perkasir") {
        ...
        } elseif ($action == "laporanharian") {
          include "view/laporan/lap_penjualan_laporanharian.php";
        } elseif ($action == "laporanbulanan") {
          include "view/laporan/lap_penjualan_laporanbulanan.php";
          ...
          include "view/laporan/lap_penjualan_supplier.php";
        } elseif ($action == "closingstall") {
          include "view/laporan/lap_closing_stall.php";
        }  
