        ...
        <div class="card card-primary">
          <form role="form" method="post" action="view/libur/proses_data.php" enctype="multipart/form-data">
                  ...
                  <tbody>
                    ...
                    for ($i=1; $i < 33; $i++) { 
                      ...
                      if ($i == 1) {
                        ...
                        ?>
                        <td align="center">
                          <input type="radio" class="form-control" name="hari_libur[]" id="tanggal<?php echo $i ?>" value="<?php echo $i ?>">
                        ...
                        if($tanggal_now != '01'){
                          if ($number_hari_now == '7') {
                            ...
                            ?>
                            <td align="center">
                              <input type="radio" class="form-control" name="tanggal[]" id="tanggal<?php echo $i ?>" value="<?php echo $i ?>">
                              <label for="tanggal<?php echo $i ?>"><?php echo $i; ?></label>
                            </td>
                            <?php
            ...
            <div class="card-footer">
              <input type="submit" name="tambah_hari_libur" class="btn btn-primary" id="btnSubmit" value="Submit">
            </div>
          </form>
        </div>
      </div>
...
<script type="text/javascript">
    ...
    $("#tahun_libur").keyup(function(){
      $("#kalender_tabel").css("display","none");  
    })
    
    $("#bulan_libur").change(function(){
      $("#kalender_tabel").css("display","none");  
    })
    ...
    var saveData = $.ajax({
      ...
      success: function(resultData) { 
        ...
        function tambah_input(increment, cellke, terpilih) {
          ...
          x.setAttribute("name", "hari_libur[]");
          x.setAttribute("id", "tanggal"+increment);
          x.setAttribute("value", increment);
          if(terpilih == true){
            x.checked = true;
          }
