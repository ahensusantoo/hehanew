...
<div class="content-header">
  <div class="container-fluid">
    <div class="row mb-2">
      <div class="col-sm-6">
        <h1 class="m-0 text-dark">Kelola File Voucher Photobooth</h1>
      </div>
    </div>
  </div>
</div>
      ...
      <div class="col-12">
        <div class="card">
          <div class="card-header">
            <h3 class="card-title">Daftar File Voucher Photobooth</h3>
          </div>
          <div class="card-body">
            <div class="table-responsive">
              <table id="example" class="table table-bordered table-striped">
                ...
                <tbody>
                  <?php
                  $nomor=1;
                  $sql = mysqli_query($db,"SELECT * FROM `voucher_photobooth`");
                  while($query = mysqli_fetch_array($sql)) {
                    ...
                    <tr>
                      ...
                      <td align="center"> 
                        ...
                        <a href="?page=file_voucherphotobooth&action=edit&eid=<?php echo $eid ?>" data-toggle="tooltip" title="Edit">
                          <button class ="btn btn-info btn-xm" style="margin: 3px"><i class="fa fa-fw fa-edit"></i></button>
                        </a>
                        <a onclick="return confirm('Yakin data ingin dihapus ?')" href="?page=file_voucherphotobooth&action=hapus&eid=<?php echo $eid ?>" data-toggle="tooltip" title="Hapus">
