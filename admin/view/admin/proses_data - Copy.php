...
if (isset($_POST['tambah_admin'])){
    ...
    $cek_username = $db->query("SELECT COUNT(*) AS jml FROM admin WHERE username_admin='$username_admin'")->fetch_assoc()['jml'];
    if ($cek_username > 0) {
...
if (isset($_POST['tambah_general_cashier_stall'])){
    ...
    $cek_username=$db->query("SELECT * 
                                ...
                                WHERE username_employee = '$username_merchant' ")->num_rows;
    ...
    $password_enkripsi = addslashes(enkripsiDekripsi($_POST['password_merchant'],'enkripsi'));
