<?php
    $query = "SELECT * FROM admin WHERE status_rmv_admin='N' AND (jabatan_admin = '3' OR jabatan_admin = '4' OR jabatan_admin = '5')";
              ...
              <tbody>
                ...
                <?php $id_enkripsi = enkripsiDekripsi($val['id_admin'],'enkripsi'); ?>
                    <tr>
                        ...
                        <td align="center"> 
                          <a href="?page=adminphotobooth&action=edit&id=<?php echo $id_enkripsi ?>" data-toggle="tooltip" title="Edit">
