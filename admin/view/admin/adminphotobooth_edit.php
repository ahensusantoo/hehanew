            ...
            <div class="card-body">              
              ...
              <div class="form-group">
                ...
                <select name="jabatan_admin" class="form-control" id="jabatan_admin" required>
                  <option value="3" <?php if($data_admin['jabatan_admin'] == "3"){ echo "selected"; }?>>Kasir Spot Photobooth</option>
                  <option value="5" <?php if($data_admin['jabatan_admin'] == "5"){ echo "selected"; }?>>Kasir Penjualan File Photobooth</option>
                </select>
              </div>
            </div>
