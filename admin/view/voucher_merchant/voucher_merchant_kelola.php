...
<div class="content-header">
  <div class="container-fluid">
    <div class="row mb-2">
      <div class="col-sm-6">
        <h1 class="m-0 text-dark">Kelola Voucher Merchant</h1>
      </div>
    </div>
  </div>
</div>
      ...
      <div class="col-12">
        <div class="card">
          <div class="card-header">
            <h3 class="card-title">Daftar Voucher Merchant</h3>
          </div>
          <div class="card-body">
                ...
                <tbody>
                  ...
                  while($query = mysqli_fetch_array($sql)) {
                    ...
                    <tr>
                      ...
                      <td> <?php echo $query['nama_merchant'] == ''? 'ALL MERCHANT' : $query['nama_merchant'] ?> </td>
                      ...
                      <td align="center"> 
                        ...
                        <a href="?page=vouchermerchant&action=edit&eid=<?php echo $eid ?>" data-toggle="tooltip" title="Edit">
                          <button class ="btn btn-info btn-xm" style="margin: 3px"><i class="fa fa-fw fa-edit"></i></button>
                        </a>
                        <a onclick="return confirm('Yakin data ingin dihapus ?')" href="view/voucher_merchant/proses_data.php?hapus_voucher=on&id=<?= $eid ?> " data-toggle="tooltip" title="Hapus">
