      ...
      <div class="col-12">
        <div class="card">
          <div class="card-header">
            ...
            <a href="view/transaksi/proses_data.php?cetak_ulang_bill=<?= enkripsiDekripsi($data_transaksi['id_transaksi'],'enkripsi') ?>" title="Cetak Ulang Bill" class="btn btn-sm btn-outline-info float-right p-0 pl-1 pr-1"><i class="fas fa-print"></i> Cetak Bill</a>
          </div>
          <div class="card-body">
            <div class="row">
              <div class="col-md-6">
                ...
                <tbody>
                  ...
                  <?php foreach ($detail_transaksi as $key => $value): ?>
                    <tr>
                      ...
                      <td>
                          <?php if ($value['status_tiket'] == "0"): ?>
                              <form action="view/transaksi/proses_data.php" method="POST">
                                  <input type="hidden" name="id_tiket" value="<?= enkripsiDekripsi($value['id_tiket'], 'enkripsi') ?>">
                                  <button type="submit" name="cetak_tiket_satuan" value="on" class="ml-3 btn btn-sm btn-info"><i class="fas fa-print"></i></button>
                              </form>
                          <?php endif ?>
