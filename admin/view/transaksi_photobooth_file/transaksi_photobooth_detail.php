...
<table style="border-collapse: collapse; width: 100%">
	<thead>
		...
		<tr>
			...
			<td> : </td>
			<td>
			    <a href="view/transaksi_photobooth_file/proses_data.php?cetak_ulang_bill=<?= enkripsiDekripsi($data_transaksi['id_photoboothambil_transaksi'],'enkripsi') ?>" class="btn btn-sm btn-outline-info  p-0 pl-1 pr-1"><i class="fas fa-print"></i> Cetak Bill</a>
			</td>
		</tr>
	</thead>
</table>
    ...
    <div class="mb-2" style="padding: 1px 5px; border: 1px solid #ebebeb; border-radius: 8px">
    	<table style="width: 100%">
    		<tbody>
    			...
    			<tr>
    				<td colspan="2" class="pl-2">Jumlah Dibeli <?= $value['jumlah_tiket'] ?> Foto</td>
    			</tr>
    		</tbody>
    	</table>
    </div>
