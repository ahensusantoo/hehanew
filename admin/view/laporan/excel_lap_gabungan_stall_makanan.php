        ...
        <?php foreach ($list_stall as $key => $value): ?>
            ...
            <?php foreach ($list_barang as $key_list_barang => $value_list_barang): ?>
                ...
                <tr>
                    ...
                    <td align="right"><?= $value_list_barang['harga_produk'] ?></td>
                    ...
                    <?php foreach ($list_stall as $key_list_stall_row => $value_list_stall_row): ?>
                        ...
                        <?php if ($value_list_stall_row['id_merchant'] == $value['id_merchant']): ?>
                            ...
                            <?php foreach ($list_kasir as $key_list_kasir => $value_list_kasir): ?>
                                ...
                                <td align="right" nowrap=""><?= $jml ?></td>
                                <td align="right" nowrap=""><?= $diskon ?></td>
                            ...
                            <?php endforeach ?>
                                ...
                                <td align="right" nowrap=""><?= $jml_satuan ?></td>
                                <td align="right" nowrap=""><?= $diskon_satuan ?></td>
                                <td align="right" nowrap=""><?= $total_satuan ?></td>
            ...
            <?php foreach ($list_stall as $key_list_stall_row => $value_list_stall_row): ?>
                ...
                <?php foreach ($list_kasir as $key => $value): ?>
                    ...
                    <?php if (isset($total_semua[$value['id_merchant_employee']]['nama'])): ?>
                        <td><?= $total_semua[$value['id_merchant_employee']]['jml'] ?></td>
                        <td><?= $total_semua[$value['id_merchant_employee']]['diskon'] ?></td>
                        <td><?= $total_semua[$value['id_merchant_employee']]['subtotal'] ?></td>
