          ...
          <div class="card-body">
            <table id="example" class="table table-bordered table-striped">
              ...
              <tbody>
                ...
                $nomor=1;
                $grand_total = 0;
                $sql = mysqli_query($db,"SELECT s.nama_shift, SUM(t.jumlah_tiket) AS jumlah_tiket, SUM(t.diskon) AS diskon, SUM(t.total_transaksi) AS total_transaksi FROM `shift` AS s
