<?php 
    ...
    $query = "
        ...
        (SELECT SUM(D.jumlah_tiket) FROM view_transaksi_join_tiket_orderby_id D WHERE D.kd_admin='$_SESSION[id_admin]' AND D.status_transaksi!='3' AND D.status_transaksi!='3' AND D.status_transaksi!='3' AND D.kd_jenis_tiket=B.kd_jenis_tiket AND DATE(D.tanggal_transaksi) BETWEEN '$mulai' AND '$akhir')AS jml,
        
        (SELECT SUM(E.nominal_sebelum_diskon) FROM view_transaksi_join_tiket_orderby_id E WHERE E.kd_admin='$_SESSION[id_admin]' AND E.status_transaksi!='3' AND E.status_transaksi!='3' AND E.status_transaksi!='3' AND E.kd_jenis_tiket=B.kd_jenis_tiket AND DATE(E.tanggal_transaksi) BETWEEN '$mulai' AND '$akhir')AS subtotal
