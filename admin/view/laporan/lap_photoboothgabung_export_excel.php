...
<input type="hidden" name="namafile" id="namafile" value="<?= 'Laporan Gabungan Spot Foto '.tanggal_indo($tgl_awal).' - '.tanggal_indo($tgl_akhir); ?>">
		...
		while($query = mysqli_fetch_array($sql)) {
			...
			<tr>
				...
				foreach($array_data_shift as $value){
					...
					<td><?= $data_pershift['jumlah_tiket']*$data_pershift['subtotal_transaksi'] ?></td>
					<?php
				}
				?>
				<td> <?php echo $query['jumlah_tiket']; ?> </td>
				<td> <?php echo $query['jumlah_tiket']*$query['subtotal_transaksi']; ?> </td>
			</tr>
		<?php } ?>
	</tbody>
	<tfoot>
