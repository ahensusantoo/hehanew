<?php
  ...
  $list_transaksi = $db->query("
    ...
    WHERE status_transaksi!='3' AND DATE(A.tanggal_transaksi) > '$mindate' 
        $query_tgl $query_pembeli $query_kasir $query_jenis_pembayaran 
    ORDER BY A.id_transaksi DESC LIMIT $awal, $perpage")->fetch_all(MYSQLI_ASSOC);
                        ...
                        <tbody>
                            ...
                            <?php foreach ($list_transaksi as $key => $value): ?>
                                <tr>
                                    ...
                                    <td><?= $value['nama_cust'] == "" ? $value['nama_cust'] : "( ".$value['no_identitas_agen']." ) <br>". $value['nama_agen'] ?></td>
