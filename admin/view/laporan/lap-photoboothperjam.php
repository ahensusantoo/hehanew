<?php 
    for($i=8; $i<24; $i++){
        ...
        $list_jam[$jam] = $db->query("SELECT AVG(jumlah_tiket) AS jml FROM transaksi WHERE HOUR(tanggal_transaksi) BETWEEN '$jam_mulai' AND '$jam_akhir'")->fetch_assoc()['jml'];
...
<div class="content-header">
  <div class="container-fluid">
    <div class="row mb-2">
      <div class="col-sm-6">
        <h1 class="m-0 text-dark">Laporan Pengunjung Photobooth</h1>
      </div>
    </div>
  </div>
</div>
