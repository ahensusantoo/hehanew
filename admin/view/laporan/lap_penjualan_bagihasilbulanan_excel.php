<?php
  ...
  header("Content-Disposition: attachment; filename=Laporan Bagi Hasil Bulanan.xls");
...
<table>
  <thead>
    <tr>
      <th colspan="4" style="text-align: center;">Laporan Penjualan Bagi Hasil Bulanan</th>
    </tr>
