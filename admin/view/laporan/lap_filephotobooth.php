...
<div class="content-header">
  <div class="container-fluid">
    <div class="row mb-2">
      <div class="col-sm-6">
        <h1 class="m-0 text-dark">Laporan File Photobooth</h1>
      </div>
    </div>
  </div>
</div>
...
<script type="text/javascript">
  $(function () {
    ...
    function (start, end) {
      ...
      var form = $('<form action="?page=lap-filephotobooth" method="post">' +
  ...
  function exportexcel(awal, akhir){
    var form = $('<form target="_blank" action="view/laporan/lap_filephotobooth_export_excel.php" method="post">' +
