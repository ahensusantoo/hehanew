<?php
    ...
    $data = $db->query("SELECT * FROM voucher_tiket WHERE id_voucher='$id_voucher'")->fetch_assoc();
?>
    ...
    <div class="row">
      <div class="col-md-12">
        <div class="card card-primary">
          ...
          <form role="form" method="post" action="view/voucher_tiket/proses_data.php" enctype="multipart/form-data">
