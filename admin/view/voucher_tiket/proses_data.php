...
if (isset($_POST['tambah_voucher_tiket'])){
    ...
    $id_voucher = createID('id_voucher', 'voucher_tiket', 'VT');
    $query = "INSERT INTO voucher_tiket SET id_voucher='$id_voucher', kode_voucher='$kode_voucher', nama_voucher='$nama_voucher', deskripsi_voucher='$deskripsi_voucher', status_potongan='$status_potongan', potongan_voucher='$potongan_voucher', start_tgl='$start_tgl', end_tgl='$end_tgl', start_jam='$start_jam', end_jam='$end_jam', max_pengguna='$max_pengguna'";
    $sql = $db->query($query);
    
    
    if($sql){
        $_SESSION['notifikasi']['success'] = "Voucher '".$nama_voucher."' berhasil ditambahkan";
        header('Location: '.base_url().'admin-super.php?page=vouchertiket&action=kelola');
        exit();
    }else{
...
if (isset($_POST['edit_voucher_tiket'])){
    ...
    $query = "UPDATE voucher_tiket SET kode_voucher='$kode_voucher', nama_voucher='$nama_voucher', deskripsi_voucher='$deskripsi_voucher', status_potongan='$status_potongan', potongan_voucher='$potongan_voucher', start_tgl='$start_tgl', end_tgl='$end_tgl', start_jam='$start_jam', end_jam='$end_jam', max_pengguna='$max_pengguna' WHERE id_voucher='$id'";
    $sql = $db->query($query);
...
if (isset($_GET['hapus_voucher'])){
    ...
    $query = "UPDATE voucher_tiket SET status_rmv_voucher='Y' WHERE id_voucher='$id'";
    $sql = $db->query($query);
