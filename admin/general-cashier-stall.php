  ...
  <div class="wrapper">
    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-4">
      <a href="#" class="brand-link">
        ...
        style="opacity: .8">
        <span class="brand-text font-weight-light">Cashier Stall</span>
      </a>
      <div class="sidebar">
        <nav class="mt-2">
    ...
    <div class="content-wrapper">
      ...
      if ($page == "dashboard") {
        ...
        if ($action == "kelola") {
          ...
          } elseif ($action2 == "ProdukTambahByExcel") {
            include "view/merchant/merchant_permerchant_produk_tambah_by_excel.php";
          ...
          } elseif ($action2 == "mutasikeluar") {
            include "view/merchant/merchant_permerchant_mutasi_keluar.php";
          } elseif ($action2 == "mutasimasuk") {
            include "view/merchant/merchant_permerchant_mutasi_masuk.php";
          } elseif ($action2 == "detailtransaksi") {
            include "view/merchant/merchant_permerchant_transaksi_detail.php";
          }elseif ($action2 == "detailmutasi") {
            include "view/merchant/merchant_permerchant_mutasi_detail.php";
          }
        }
